        ...
        <CoachCard className="p-5 sm:p-6">
          ...
          {results && (
            <EmptyCoachState
              ...
              body={isUk ? 'Ваші відповіді збережено. Далі завантажте наявні результати або перегляньте план аналізів.' : 'Your answers are saved. Next, upload existing results or review the lab plan.'}
              actionLabel={isUk ? 'Завантажити аналізи' : 'Upload labs'}
              onAction={() => navigate('/upload')}
            />
          )}
        </CoachCard>
