...
import { CTA_CLASS, PRICING, UaFooter, UaHeader, getUaAuthPath, getUaPath } from './UaLanding.jsx'
...
const PAGE_CONTENT = {
  ...
  laboratorii: {
    ...
    description:
      'Vitaloop працює з результатами у форматі PDF, фото або скану. Назва лабораторії не має бути барʼєром: важлива якість файлу і зрозумілі показники.',
    icon: FlaskConical,
    cta: 'Додати результати',
    blocks: [
      ['PDF із кабінету', 'Найкращий формат для автоматичного зчитування показників, одиниць і референсів.'],
      ['Фото або скан', 'Підійде, якщо текст чіткий, сторінка рівна і видно всі значення.'],
      ['Українські формати', 'Сервіс зберігає назви показників і допомагає читати їх зрозумілою мовою.'],
      ['Без списку партнерів', 'Ми не називаємо лабораторії партнерами без офіційної домовленості.'],
    ],
    steps: [
      ['Завантаження', 'Додаєте PDF, фото або скан результатів.'],
      ['Нормалізація', 'Показники, одиниці та референси збираються в одну структуру.'],
      ['Підсумок', 'Отримуєте пояснення, пріоритети і питання для консультації.'],
    ],
  },
  tarify: {
    eyebrow: 'Тарифи',
    ...
    steps: [
      ...
      ['249 грн/міс', 'Або 2499 грн/рік — проста ціна для регулярної роботи зі станом.'],
    ],
  },
  faq: {
  ...
  ferytyn: {
    ...
    description:
      'Феритин показує запаси заліза. Його часто дивляться при втомі, випадінні волосся, слабкості й проблемах з відновленням.',
    icon: FlaskConical,
    cta: 'Перевірити мої симптоми',
    blocks: [
      ['Проблема', 'Людина може мати нормальний гемоглобін, але низькі запаси заліза і скарги на втому.'],
      ['Що дивитися', 'Феритин варто оцінювати разом із симптомами, ЗАК, харчуванням і динамікою.'],
      ['Рішення', 'Vitaloop структурує симптоми й результати, щоб підготувати питання до лікаря без самодіагностики.'],
    ],
    steps: [
      ['Опишіть втому', 'Коли виникає, що погіршує і що змінилося останнім часом.'],
      ['Додайте аналізи', 'Завантажте результати, якщо вони вже є.'],
      ['Отримайте підсумок', 'Побачите, що обговорити і що відстежувати далі.'],
    ],
  },
  vtoma: {
    eyebrow: 'Корисні матеріали',
    title: 'Чому виникає втома',
    description:
      'Втома може бути повʼязана зі сном, дефіцитами, стресом, навантаженням або кількома факторами одночасно.',
    icon: HeartPulse,
    cta: 'Розібрати втому',
    blocks: [
      ['Проблема', 'Загальна порада “більше відпочивайте” не допомагає, якщо причина не структурована.'],
      ['Контекст', 'Важливі тривалість, сон, енергія протягом дня, харчування, ліки й аналізи.'],
      ['Рішення', 'Vitaloop збирає ці дані в одну картину і виділяє пріоритети для наступного кроку.'],
    ],
    steps: [
      ['Симптоми', 'Опишіть втому простими словами.'],
      ['Звʼязки', 'Додайте сон, стрес і супутні скарги.'],
      ['План', 'Отримайте напрямки перевірок і питання до спеціаліста.'],
    ],
  },
  'vitamin-d': {
    eyebrow: 'Корисні матеріали',
    title: 'Як зрозуміти дефіцит вітаміну D',
    description:
      'Вітамін D часто обговорюють при низькій енергії, частих застудах і відновленні, але результат потрібно читати в контексті.',
    icon: Sparkles,
    cta: 'Перевірити контекст',
    blocks: [
      ['Проблема', 'Окреме число в бланку не пояснює, що робити далі і коли повторити аналіз.'],
      ['Що важливо', 'Одиниці, референси лабораторії, симптоми, сезонність і попередні результати.'],
      ['Рішення', 'Vitaloop допомагає побачити показник у динаміці та сформувати питання до лікаря.'],
    ],
    steps: [
      ['Додайте результат', 'Завантажте PDF або фото.'],
      ['Опишіть стан', 'Позначте енергію, сон, часті застуди або інші скарги.'],
      ['Отримайте фокус', 'Побачите, що варто обговорити і відстежити.'],
    ],
  },
  volossia: {
    eyebrow: 'Корисні матеріали',
    title: 'Причини випадіння волосся',
    description:
      'Випадіння волосся може мати різні причини: дефіцити, стрес, гормональні фактори, відновлення після хвороби.',
    icon: SearchCheck,
    cta: 'Структурувати симптоми',
    blocks: [
      ['Проблема', 'Важко зрозуміти, з чого почати, коли симптом помітний, а причин може бути багато.'],
      ['Що зібрати', 'Тривалість, харчування, стрес, цикл, хвороби, феритин, вітамін D та інші показники.'],
      ['Рішення', 'Vitaloop допомагає підготувати структурований запит для консультації.'],
    ],
    steps: [
      ['Опишіть зміну', 'Коли почалося і як проявляється.'],
      ['Додайте аналізи', 'Якщо є результати, завантажте їх.'],
      ['Отримайте питання', 'Побачите, що варто уточнити зі спеціалістом.'],
    ],
  },
  son: {
    eyebrow: 'Корисні матеріали',
    title: 'Як покращити сон без загальних порад',
    description:
      'Сон варто описувати конкретно: засинання, пробудження, якість відновлення, стрес і ранкова енергія.',
    icon: BarChart3,
    cta: 'Описати сон',
    blocks: [
      ['Проблема', 'Поради про сон часто занадто загальні і не враховують ваш контекст.'],
      ['Що важливо', 'Час засинання, нічні пробудження, ранкова втома, кофеїн, стрес і навантаження.'],
      ['Рішення', 'Vitaloop поєднує опис сну з іншими симптомами й аналізами для кращого наступного кроку.'],
    ],
    steps: [
      ['Зафіксуйте сон', 'Опишіть кілька ключових деталей.'],
      ['Додайте симптоми', 'Позначте втому, тривожність або концентрацію.'],
      ['Отримайте фокус', 'Побачите, що може мати сенс перевірити.'],
    ],
  },
  'dity-analizy': {
    eyebrow: 'Корисні матеріали',
    title: 'Аналізи для дітей: як підготуватися',
    description:
      'Для дитячих питань важливо не робити висновки самостійно, а підготувати симптоми й результати до розмови з педіатром.',
    icon: ClipboardList,
    cta: 'Підготувати питання',
    blocks: [
      ['Проблема', 'Батькам складно зібрати історію симптомів, харчування, частих захворювань і аналізів в одному місці.'],
      ['Що зібрати', 'Скарги, тривалість, сон, апетит, енергію, попередні результати й питання до педіатра.'],
      ['Рішення', 'Vitaloop структурує інформацію, але рішення щодо дітей завжди має залишатися за лікарем.'],
    ],
    steps: [
      ['Опишіть стан', 'Що турбує і як давно.'],
      ['Додайте результати', 'Завантажте аналізи, якщо вони вже є.'],
      ['Підготуйте консультацію', 'Отримайте список питань і даних для лікаря.'],
    ],
  },
}
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-3">
      {PRICING.map((plan) => (
        <article
          key={plan.name}
          className={`relative flex h-full flex-col rounded-[28px] border p-5 shadow-sm sm:p-6 ${plan.featured ? 'border-[#0f766e] bg-[#0f172a] text-white shadow-[0_28px_80px_rgba(15,23,42,0.24)]' : plan.comingSoon ? 'border-[#e5dfd6] bg-[#f8f5f0] text-[#0f172a]' : 'border-[#e5dfd6] bg-white text-[#0f172a]'}`}
        >
          {plan.featured && (
