    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <button className="px-6 py-2 bg-white/10 hover:bg-white/20 border border-white/30 rounded-lg font-semibold text-white transition">
                    Learn More →
                  </button>
                </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <button onClick={() => navigate('/example-report')} className="px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold rounded-lg transition">
            See Example Report
          </button>
