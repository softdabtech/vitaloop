...
const COPY = {
  en: {
    ...
    reasons: {
      ...
      results_progress_tracking: 'Want to track changes over time? Premium adds personal baseline, progress trends, and deeper follow-up across reports.',
      protocol_follow_through: 'Premium helps you keep this plan moving: repeat checks, progress trends, and doctor discussion prep across reports.',
    },
  ...
  uk: {
    ...
    reasons: {
      ...
      results_progress_tracking: 'Хочете відстежувати зміни з часом? Premium додає особисту динаміку, графіки прогресу та глибший супровід між звітами.',
      protocol_follow_through: 'Premium допомагає підтримувати цей план: повторні перевірки, динаміка прогресу та підготовка до розмови з лікарем між звітами.',
    },
