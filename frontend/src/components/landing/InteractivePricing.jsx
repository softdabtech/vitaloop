  ...
  monthly: [
    {
      ...
      price: '$0',
      period: '/month',
      description: 'Validate the workflow with your own lab report',
      points: ['1 active lab upload', 'Core biomarker summary', 'Top problems highlighted', 'Basic dashboard'],
      cta: 'Try free',
      featured: false,
    },
    {
      ...
      price: '$19.99',
      period: '/month',
      description: 'For active protocol execution',
    ...
    },
    {
      ...
      price: '$99',
      period: '/month',
      description: 'For practitioner teams and client operations',
      points: ['Everything in Premium', 'Practitioner CRM workspace', 'Client assignment workflows', 'Protocol templates', 'Team visibility and coordination', 'Priority support'],
      cta: 'Get Pro Premium',
      featured: false,
    },
  ],
