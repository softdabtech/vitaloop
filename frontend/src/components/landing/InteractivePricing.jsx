...
const PRICING = {
  monthly: [
    ...
    },
    {
      ...
      price: '$99',
      period: '/month',
      description: 'Advanced tier with closed capabilities',
      points: ['Everything in Premium', 'Closed beta features access', 'Advanced protocol templates', 'Priority implementation queue', 'Direct specialist review channel', 'Early rollout modules'],
      cta: 'Get Pro Premium',
      featured: false,
    },
  ],
