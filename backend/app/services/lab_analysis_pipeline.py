...
def normalize_biomarkers(
    ...
    *,
    ...
    for item in raw_biomarkers or []:
        ...
        # Stage 2A (F04): exclude document metadata (dates, IDs, contact/admin
        # fields) before it can be normalized/persisted as a biomarker candidate.
        # See docs/audit/VITALOOP_STAGE2_IMPLEMENTATION_PLAN.md, Stage 2A.
